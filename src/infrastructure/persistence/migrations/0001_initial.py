...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.GenericIPAddressField(
                        db_index=True, unique=True, verbose_name="IP地址"
                    ),
                ),
                (
                    "reason",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "resource",
                    models.CharField(
                        db_index=True, max_length=50, verbose_name="资源类型"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "key",
                    models.CharField(
                        db_index=True, max_length=255, verbose_name="限流键"
                    ),
                ),
                (
                    "endpoint",
                    models.CharField(
                        db_index=True, max_length=255, verbose_name="API端点"
                    ),
                ),
                (
                    "method",
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=60, verbose_name="允许的请求次数"
                    ),
                ),
                (
                    "period",
                    models.PositiveIntegerField(
                        default=60, verbose_name="时间周期(秒)"
                    ),
                ),
                (
                    "scope",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "company",
                    models.CharField(
                        blank=True, max_length=200, null=True, verbose_name="公司"
                    ),
                ),
                (
                    "occupation",
        ...
        migrations.AddIndex(
            model_name="loginlog",
            index=models.Index(
                fields=["login_time"], name="login_logs_login_t_bc25ca_idx"
            ),
        ),
        migrations.AddIndex(
