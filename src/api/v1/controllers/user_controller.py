...
class UserController:
    ...
    @http_post("/users", response=UserResponseDTO, summary="创建用户", operation_id="user_create")
    ...
    @http_post(
        "/users/change-password", response=MessageResponse, summary="修改密码", operation_id="user_change_password", permissions=[IsAuthenticated]
    )
    ...
    @http_get("/me", response=UserResponseDTO, summary="获取当前用户信息", operation_id="user_get_current", permissions=[IsAuthenticated])
