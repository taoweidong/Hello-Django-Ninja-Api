...
class SystemController:
    ...
    def health_check(self) -> dict:
        ...
        return {
            "status": "ok",
            "message": "服务运行正常",
            "service": "Hello-Django-Ninja-Api",
            "version": "1.0.0",
        }
    ...
    @http_post(
        "/depts",
        response=DeptResponseDTO,
        summary="创建部门",
        operation_id="system_create_dept"
    )
    ...
    @http_put(
        ...
        response=DeptResponseDTO,
        summary="更新部门",
        operation_id="system_update_dept"
    )
    ...
    @http_delete(
        ...
        summary="删除部门",
        operation_id="system_delete_dept"
    )
    ...
    @http_get(
        "/depts",
        response=DeptListResponse,
        summary="获取部门列表",
        operation_id="system_list_depts"
    )
    ...
    @http_get(
        "/depts/tree",
        response=list[DeptTreeDTO],
        summary="获取部门树形结构",
        operation_id="system_get_dept_tree"
    )
    ...
    @http_post(
        ...
        summary="创建菜单",
        operation_id="system_create_menu"
    )
    ...
    @http_put(
        ...
        response=MenuResponseDTO,
        summary="更新菜单",
        operation_id="system_update_menu"
    )
    ...
    @http_delete(
        ...
        response=MessageResponse,
        summary="删除菜单",
        operation_id="system_delete_menu"
    )
    ...
    @http_get(
        ...
        summary="获取菜单列表",
        operation_id="system_list_menus"
    )
    ...
    @http_get(
        "/menus/tree",
        response=list[MenuTreeDTO],
        summary="获取菜单树形结构",
        operation_id="system_get_menu_tree"
    )
    ...
    @http_post(
        ...
        summary="创建角色",
        operation_id="system_create_role"
    )
    ...
    @http_put(
        ...
        response=RoleResponseDTO,
        summary="更新角色",
        operation_id="system_update_role"
    )
    ...
    @http_delete(
        ...
        response=MessageResponse,
        summary="删除角色",
        operation_id="system_delete_role"
    )
    ...
    @http_get(
        ...
        summary="获取角色列表",
        operation_id="system_list_roles"
    )
    ...
    @http_post(
        ...
        response=MessageResponse,
        summary="为角色分配菜单权限",
        operation_id="system_assign_menus"
    )
    async def assign_menus_to_role(
        self,
        role_id: str,
        dto: RoleAssignMenuDTO
    ) -> MessageResponse:
        """
        为角色分配菜单权限
    ...
    @http_get(
        ...
        response=MenuListResponse,
        summary="获取角色的菜单列表",
        operation_id="system_get_role_menus"
    )
    ...
    @http_post(
        ...
        response=MessageResponse,
        summary="为用户分配角色",
        operation_id="system_assign_user_roles"
    )
    ...
    @http_get(
        ...
        response=RoleListResponse,
        summary="获取用户的角色列表",
        operation_id="system_get_user_roles"
    )
    ...
    @http_get(
        ...
        response=MenuListResponse,
        summary="获取用户的菜单权限",
        operation_id="system_get_user_menus"
    )
