...
class RBACController:
    ...
    @http_get(
        ...
        summary="获取权限列表",
        operation_id="rbac_list_permissions"
    )
    ...
    @http_post(
        ...
        response=MessageResponse,
        summary="初始化系统权限",
        operation_id="rbac_init_permissions"
    )
    ...
    @http_get(
        ...
        summary="获取用户角色权限",
        operation_id="rbac_get_user_roles"
    )
    ...
    @http_get(
        ...
        summary="检查用户权限",
        operation_id="rbac_check_permission"
    )
    async def check_user_permission(
        self,
        user_id: str,
        permission_code: Annotated[str, Query()]
    ) -> dict:
        """
        检查用户权限
        ...
        Returns:
            dict: 包含检查结果的字典
        """
        has_permission = await self._rbac_service.check_user_permission(
