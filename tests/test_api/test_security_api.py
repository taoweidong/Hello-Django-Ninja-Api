...
class TestSecurityAPI:
    ...
    def test_add_to_whitelist_success(self):
        ...
        response = self.client.post(
            f"{self.base_url}/security/whitelist",
    ...
    def test_toggle_rate_limit_rule_success(self):
        ...
        response = self.client.put(
            f"{self.base_url}/security/rate-limit/{rule['rule_id']}/toggle"
        )
        assert response.status_code == 200
    ...
    def test_delete_rate_limit_rule_success(self):
        ...
        response = self.client.delete(
            f"{self.base_url}/security/rate-limit/{rule['rule_id']}"
        )
        assert response.status_code == 200
        data = json.loads(response.content)
